...
import com.example.FindJobIT.domain.response.file.ResUploadFileDTO;
import com.example.FindJobIT.service.FileService;
import com.example.FindJobIT.util.annotation.ApiMessage;
import com.example.FindJobIT.util.error.StorageException;
...
public class FileController {
    ...
    @Value("${findjobit.upload-file.base-uri}")
